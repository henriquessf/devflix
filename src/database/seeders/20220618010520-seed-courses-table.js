...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert('courses', [
      ...
      {
        name: 'Visual Studio para Programadores Javascript',
        synopsis:
          'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
        category_id: courses[3].id,
        created_at: new Date(),
        updated_at: new Date()
      },
      {
      ...
      {
        name: 'Como ser um Programador Produtivo',
        synopsis:
          'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
        category_id: courses[4].id,
        created_at: new Date(),
        updated_at: new Date()
      },
      {
      ...
      {
        name: 'Inglês Técnico para Programadores',
        synopsis:
          'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
        category_id: courses[6].id,
        created_at: new Date(),
        updated_at: new Date()
      }
    ])
