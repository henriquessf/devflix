...
router.get('/courses/newest', coursesController.newest) //a ordem das rotas deve ser por ordem de endpoint
router.get('/courses/featured', coursesController.featured) //a ordem das rotas deve ser por ordem de endpoint
router.get('/courses/search', coursesController.search) //a ordem das rotas deve ser por ordem de endpoint
